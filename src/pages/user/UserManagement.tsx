...
function UserManagement() {
  ...
  const filteredUsers = users.filter(user => {
    return (
      (filters.username === "" || user.firstName.toLowerCase().includes(filters.username.toLowerCase())) &&
      (filters.userId === "" || user.id.toLowerCase().includes(filters.userId.toLowerCase())) &&
